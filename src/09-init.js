...
function tourModal() {
  openModal('🧭 جرّب أهم 7 ميزات في دقيقة', `
    <div class="timeline">
      ...
      <div class="tl-item"><div class="b sm">4 · محلات حقيقية حولك</div><div class="tiny muted">صفحة «المتاجر القريبة»: اضغط «استخدم موقعي» وسوقي يبحث فعليًا في Google Maps عن المحلات المسجّلة حولك (اسم، نوع، مسافة، تليفون، مواعيد) بنطاق من 300 متر حتى 25 كم — بدون أي محلات وهمية.</div></div>
